...
local function list_all_plugins(only_enabled)
  ...
  local text = text..'\n '..nsum..' پلاگین نصب شده است.\n'..nact..' پلاگین فعال است و '..nsum-nact..' پلاگین غیرفعال است'
  return text
end
...
local function list_plugins(only_enabled)
  ...
  local text = text..'\n'..nact..' پلاگین فعال از '..nsum..' پلاگین نصب شده.'
  return text
end
...
local function enable_plugin( plugin_name )
  ...
  if plugin_exists(plugin_name) then
    ...
    return 'پلاگین '..plugin_name..' نصب نشده است'
  end
end
...
local function disable_plugin( name, chat )
  ...
  if not plugin_exists(name) then
    return 'پلاگین '..name..' نصب نشده است'
  end
...
local function reenable_plugin_on_chat(receiver, plugin)
  if not _config.disabled_plugin_on_chat then
    return 'هیچ پلاگین غیرفعالی وجود ندارد'
  end

  if not _config.disabled_plugin_on_chat[receiver] then
    return 'هیچ پلاگین غیرفعالی برایه این گروه وجود ندارد'
  end
